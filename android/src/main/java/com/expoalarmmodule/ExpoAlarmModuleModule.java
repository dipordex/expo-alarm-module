...
public class ExpoAlarmModuleModule extends ReactContextBaseJavaModule {
    ...
    private Alarm parseAlarmObject(ReadableMap alarm) {
        ...
        // 🔹 Sound
        String sound = alarm.hasKey("sound") ? alarm.getString("sound") : "";
        ...
        return new Alarm(uid, days, date, hour, minutes, showDismiss, showSnooze, snoozeInterval,
                title, description, repeating, active, dismissText, snoozeText, sound);
    }
